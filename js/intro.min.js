...
!(function (t, e) {
        ...
        return (
            ...
            (S.prototype = {
                ...
                delegateYield: function (t, e, n) {
                    return (this.delegate = { iterator: j(t), resultName: e, nextLoc: n }), "next" === this.method && (this.arg = void 0), h;
                },
            }),
            e
        );
    ...
    var ct = R,
                ...
                ? Vt
                    ? function (t, e, n) {
                          if ((Kt(t), (e = Ht(e)), Kt(n), "function" == typeof t && "prototype" === e && "value" in n && ee in n && !n.writable)) {
                              var r = Jt(t, e);
                              r && r.writable && ((t[e] = n.value), (n = { configurable: te in n ? n.configurable : r.configurable, enumerable: Zt in n ? n.enumerable : r.enumerable, writable: !1 }));
                          }
                          return Qt(t, e, n);
                      }
                    : Qt
        ...
        ae = Ct(oe, "name"),
        se = { EXISTS: ae, PROPER: ae && "something" === function () {}.name, CONFIGURABLE: ae && (!M || (M && ie(oe, "name").configurable)) },
    ...
    var Ce = {
            ...
            var e = se.CONFIGURABLE,
                ...
                s = (t.exports = function (t, r, s) {
                    "Symbol(" === String(r).slice(0, 7) && (r = "[" + String(r).replace(/^Symbol\(([^)]*)\)/, "$1") + "]"),
                        s && s.getter && (r = "get " + r),
                        s && s.setter && (r = "set " + r),
                        (!Ct(t, "name") || (e && t.name !== r)) && (M ? o(t, "name", { value: r, configurable: !0 }) : (t.name = r)),
                        i && s && Ct(s, "arity") && t.length !== s.arity && o(t, "length", { value: s.arity });
                    try {
                        s && Ct(s, "constructor") && s.constructor ? M && o(t, "prototype", { writable: !1 }) : t.prototype && (t.prototype = void 0);
                    } catch (t) {}
                    var c = n(t);
        ...
        Ee = function (t, e, n, r) {
            ...
            if ((J(n) && Ae(n, i, r), r.global)) o ? (t[e] = n) : yt(e, n);
                ...
                o ? (t[e] = n) : ne.f(t, e, { value: n, enumerable: !1, configurable: !r.nonConfigurable, writable: !r.nonWritable });
            }
            return t;
        },
        Ne = Math.ceil,
        ...
        An = function () {
            ...
            An =
                "undefined" != typeof document
                    ? document.domain && an
                        ? Cn(an)
                        : (((e = $t("iframe")).style.display = "none"), _n.appendChild(e), (e.src = String("javascript:")), (t = e.contentWindow.document).open(), t.write(jn("document.F=Object")), t.close(), t.F)
                    : Cn(an);
        ...
        (Mn = function (t) {
            ...
            if (
                (f &&
                    ...
                    -1 === Fn(d, "g") && (d += "g"),
                    (g = $n(u, c.lastIndex)),
                    c.lastIndex > 0 && (!c.multiline || (c.multiline && "\n" !== Hn(u, c.lastIndex - 1))) && ((b = "(?: " + b + ")"), (g = " " + g), m++),
                    (n = new RegExp("^(?:" + b + ")", d))),
                Wn && (n = new RegExp("^" + b + "$(?!\\s)", d)),
                Gn && (r = c.lastIndex),
                (o = C(Bn, f ? n : c, g)),
                f ? (o ? ((o.input = $n(o.input, m)), (o[0] = $n(o[0], m)), (o.index = c.lastIndex), (c.lastIndex += o[0].length)) : (c.lastIndex = 0)) : Gn && o && (c.lastIndex = c.global ? o.index + o[0].length : r),
                Wn &&
                    o &&
                    o.length > 1 &&
                    C(qn, o[0], n, function () {
    ...
    function xr(t) {
        if (t) {
            ...
            g(e.element) ? u(t, "introjs-fixedTooltip") : yr(t, "introjs-fixedTooltip"),
                ...
                wr(t, { width: "".concat(n.width + r, "px"), height: "".concat(n.height + r, "px"), top: "".concat(n.top - r / 2, "px"), left: "".concat(n.left - r / 2, "px") });
        }
    }
    !(function (t, e, n, r) {
        var o = Rt(t),
        ...
        if (!i || !a || n) {
            var s = L(/./[o]),
                c = e(o, ""[t], function (t, e, n, r, o) {
                    var a = L(t),
                        c = e.exec;
                    return c === Vn || c === Yn.exec ? (i && !o ? { done: !0, value: s(e, n, r) } : { done: !0, value: a(n, e, r) }) : { done: !1 };
                });
            ...
            switch (c) {
                ...
                case "right":
                    (e.style.left = "".concat(a.width + 20, "px")),
                        a.top + i.height > s.height ? ((n.className = "introjs-arrow left-bottom"), (e.style.top = "-".concat(i.height - a.height - 20, "px"))) : (n.className = "introjs-arrow left");
                    break;
                case "left":
                    r || !0 !== this._options.showStepNumbers || (e.style.top = "15px"),
                        a.top + i.height > s.height ? ((e.style.top = "-".concat(i.height - a.height - 20, "px")), (n.className = "introjs-arrow right-bottom")) : (n.className = "introjs-arrow right"),
    ...
    function qr() {
        ...
        null === t && ((t = Or("div", { className: "introjs-disableInteraction" })), this._targetElement.appendChild(t)), xr.call(this, t);
    }
    function Br(t) {
        var e = this,
                                    ...
                                    if (
                                        ...
                                        null !== i && null !== a
                                            ...
                                            : ((x = Or("div", { className: s })),
                                              ...
                                              (E = Or("div")),
                                              wr(x, { "box-shadow": "0 0 1px 2px rgba(33, 33, 33, 0.8), rgba(33, 33, 33, ".concat(o._options.overlayOpacity.toString(), ") 0 0 0 5000px") }),
                                              f.call(o, n),
                                              xr.call(o, x),
                                              xr.call(o, _),
                                              ...
                                              this._options.dontShowAgain &&
                                                  ...
                                                  ((I = Or("input", { type: "checkbox", id: "introjs-dontShowAgain", name: "introjs-dontShowAgain" })).onchange = function (t) {
                                                      P.setDontShowAgain(t.target.checked);
                                                  }),
                                                  ((L = Or("label", { htmlFor: "introjs-dontShowAgain" })).innerText = this._options.dontShowAgainLabel),
                                                  N.appendChild(I),
                                                  N.appendChild(L),
                                                  S.appendChild(N)),
                                              ...
                                              !0 === this._options.showStepNumbers &&
                                                  ((T.className = "introjs-helperNumberLayer"), (T.innerHTML = "".concat(n.step, " ").concat(this._options.stepNumbersOfLabel, " ").concat(this._introItems.length)), S.appendChild(T)),
                                              S.appendChild(k),
                                              _.appendChild(S),
                                              ((c = Or("a")).onclick = r(
                                                  t().mark(function e() {
                                        ...
                                        0 === this._currentStep && this._introItems.length > 1
                                            ? (null != c && ((c.className = "".concat(this._options.buttonClass, " introjs-nextbutton")), (c.innerHTML = this._options.nextLabel)),
                                              !0 === this._options.hidePrev
                                                  ? (null != l && (l.className = "".concat(this._options.buttonClass, " introjs-prevbutton introjs-hidden")), null != c && u(c, "introjs-fullbutton"))
                                                  : null != l && (l.className = "".concat(this._options.buttonClass, " introjs-prevbutton introjs-disabled")))
                                            : this._introItems.length - 1 === this._currentStep || 1 === this._introItems.length
                                            ? (null != l && (l.className = "".concat(this._options.buttonClass, " introjs-prevbutton")),
                                              !0 === this._options.hideNext
                                                  ? (null != c && (c.className = "".concat(this._options.buttonClass, " introjs-nextbutton introjs-hidden")), null != l && u(l, "introjs-fullbutton"))
                                                  : null != c &&
                                                    (!0 === this._options.nextToDone
                                                        ? ((c.innerHTML = this._options.doneLabel), u(c, "".concat(this._options.buttonClass, " introjs-nextbutton introjs-donebutton")))
                                                        : (c.className = "".concat(this._options.buttonClass, " introjs-nextbutton introjs-disabled"))))
                                            : (null != l && (l.className = "".concat(this._options.buttonClass, " introjs-prevbutton")),
                                              null != c && ((c.className = "".concat(this._options.buttonClass, " introjs-nextbutton")), (c.innerHTML = this._options.nextLabel))),
                        ...
                        for (;;)
                            switch ((t.prev = t.next)) {
                                case 0:
                                    if (
                                        ((n = this),
                                        null === (r = document.querySelector(".introjs-hints")) && (r = Or("div", { className: "introjs-hints" })),
                                        (o = function (t) {
                                            return function (e) {
                                ...
                                case 8:
                                    (a = Or("div", { className: "introjs-tooltip" })),
                                        ...
                                        this._options.hintShowButton &&
                                            (((h = Or("a")).className = this._options.buttonClass), h.setAttribute("role", "button"), (h.innerHTML = this._options.hintButtonLabel), (h.onclick = oo.bind(this, n)), s.appendChild(h)),
        ...
        if (this._options.steps)
            c(this._options.steps, function (t) {
                ...
                if (((n.step = r.length + 1), (n.title = n.title || ""), "string" == typeof n.element && (n.element = document.querySelector(n.element)), void 0 === n.element || null === n.element)) {
                    ...
                    null === o && ((o = Or("div", { className: "introjsFloatingElement" })), document.body.appendChild(o)), (n.element = o), (n.position = "floating");
                }
    ...
    function ko(t) {
        ...
        if (
            ...
            xr.call(this, e),
            xr.call(this, r),
            t && ((this._introItems = _o.call(this, this._targetElement)), Mr.call(this, e, this._introItems[this._currentStep]), Dr.call(this, e)),
